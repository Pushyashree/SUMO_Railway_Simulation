...
For more details, refer to the official SUMO NETEDIT documentation: (https://sumo.dlr.de/docs/NETEDIT.html).
...
For more information on defining rail signals, refer to: (https://sumo.dlr.de/docs/NETEDIT.html#rail_signals).
...
For detailed instructions on adding stops using NETEDIT, refer to: (https://sumo.dlr.de/docs/NETEDIT.html#bus_stops).
...
For more detailed workflows on creating trips, refer to: (https://sumo.dlr.de/docs/Simulation/Trips.html).
...
Additional DUAROUTER options and commands can be found here: (https://sumo.dlr.de/docs/duarouter.html).
...
For more details on configuration files, refer to: (https://sumo.dlr.de/docs/Simulation/Configuration.html).
...
For a comprehensive list of output files and their formats, refer to: (https://sumo.dlr.de/docs/Simulation/Output/index.html).
